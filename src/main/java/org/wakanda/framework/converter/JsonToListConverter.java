...
/**
 * Json to List converter for attribute type variation.
 *
...
public class JsonToListConverter implements AttributeConverter<List<?>, String> {
  ...
  @Override
  public List<?> convertToEntityAttribute(String jsonString) {
    if (Objects.isNull(jsonString)) return Collections.emptyList();
    List<?> objectList = null;
    try {
      objectList = objectMapper.readValue(jsonString, List.class);
